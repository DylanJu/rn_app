...
describe('Commands', () => {
    ...
    beforeEach(() => {
        ...
        commandsObserver = new CommandsObserver_1.CommandsObserver(new UniqueIdProvider_mock_1.UniqueIdProvider());
        ...
        uut = new Commands_1.Commands(nativeCommandsSender, new LayoutTreeParser_1.LayoutTreeParser(), new LayoutTreeCrawler_1.LayoutTreeCrawler(new UniqueIdProvider_mock_1.UniqueIdProvider(), store, optionsProcessor), commandsObserver, new UniqueIdProvider_mock_1.UniqueIdProvider(), optionsProcessor);
    });
    describe('setRoot', () => {
    ...
    describe('notifies commandsObserver', () => {
        ...
        beforeEach(() => {
            ...
            const mockedOptionsProcessor = ts_mockito_1.mock(OptionsProcessor_1.OptionsProcessor);
            const optionsProcessor = ts_mockito_1.instance(mockedOptionsProcessor);
            uut = new Commands_1.Commands(mockedNativeCommandsSender, mockParser, mockCrawler, commandsObserver, new UniqueIdProvider_mock_1.UniqueIdProvider(), optionsProcessor);
        });
